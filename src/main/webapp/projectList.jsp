        ...
        <div class="col-md-12" align="center">
            <ul class="pagination pagination-lg">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${cps}/index/projectList.do?page=${pageData.pageNum-1}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">Prev</a></li>
                    </c:otherwise>
                </c:choose>
                <%-- 页码 --%>
                <c:forEach var="pageSize" begin="1" end="${pageData.pages}">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class=""><a href="${cps}/index/projectList.do?page=${pageSize}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">${pageSize}</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                <%-- 尾页 --%>
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${cps}/index/projectList.do?page=${pageData.pageNum+1}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">Next</a></li>
                    </c:otherwise>
                </c:choose>
            </ul>
        </div>
