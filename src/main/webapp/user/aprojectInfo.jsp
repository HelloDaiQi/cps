...
<script>
    ...
    window.operateEvents = {
        'click .RoleOfedit': function (e, value, row, index) {
            var projectid = row.project.projectid;
            window.location.href="${cps}/index/showProject.do?projectid="+projectid;
        },
        'click .RoleOfdelete': function (e, value, row, index) {
            var aprojectid=row.aprojectid;
            Ewin.confirm({ message: "确认要删除选择的数据吗？" }).on(function (e) {
                ...
                $.ajax({
                    type: "post",
                    url: "${cps}/aproject/deleteAproject.do",
                    data: { "aprojectid": aprojectid },
...
<script type="text/javascript">
    $("#aprojectTable").bootstrapTable({
        url:'${cps}/project/aprojectInfoList.do',
        //是否显示查找
        search: false,
        //是否分页
        pagination: true,
        ...
        striped: true,
        columns:[
            {title:'序号',field:'aprojectid'},
            {title:'项目名称',field:'projectname',
                formatter:function(value,row,index){
                    return row.project.projectname;
                }
            },
            {title:'申请理由',field:'reason'},
            {title:'申请结果',field:'result'},
