    ...
    window.operateEvents = {
        'click .RoleOfedit': function (e, value, row, index) {
            ...
            if(introduction.length>33 && introduction.length<=66){
                ...
                introduction2+=introduction.substring(34,introduction.length-1);
            ...
            var content3='</tbody>\n' +
                '</table>';
            $("#myModal").find('.modal-body').html(content1+tmp1+content3);
    ...
    <div class="row">
        <div class="col-md-2">
            <ul class="nav nav-list">
                ...
                <li><a style=""
                       href="${cps}/project/rprojectInfo.do">发布项目信息</a></li>
                <%--<li><a style="background-color: #deded4"
                       href="${cps}/project/historyRprojectInfo.do">发布项目(完成)</a></li>--%>
                <li><a
                ...
                <li><a
                        href="${cps}/message/receiveMessageList.do">我收到的私信</a></li>
                <li><a
...
<script type="text/javascript">
    ...
    $("#projectTable").bootstrapTable({
        url:'${cps}/project/historyRprojectInfoList.do',
        //是否显示查找
        search: false,
        //是否分页
        pagination: true,
