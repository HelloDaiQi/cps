...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8">
            <form method="post" enctype="multipart/form-data" action="${cps}/project/updateRproject.do">
                <table class="table table-bordered">
                    <tbody>
                    <tr>
                        <td>图片介绍
                            <div id="imgDiv">
                                <img id="img" style="width: 80px;" src="${cps}/mysrc/${projectExtends.projectimage}">
                            </div>
                            <input type="file" onChange="setImagePreview(this,imgDiv,img);" name="file">
                        </td>
                        <td><input type="hidden" name="projectid" value="${projectExtends.projectid}" /></td>
                    </tr>
                    <tr>
                        <td>
                            <div class="input-group">
                                <span class="input-group-addon">项目名称</span>
                                <input type="text" name="projectname" value="${projectExtends.projectname}"
                                       class="form-control" placeholder="请输入当前项目名称" required="required">
                            </div>
                        </td>
                        <td></td>
                    </tr>
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="projecttype">
                                    ...
                                    <c:forEach var="projectType" items="${projectTypeList}">
                                        <c:choose>
                                            <c:when test="${projectType.typeid==projectExtends.projecttype}">
                    ...
                    <tr>
                        <td>
                            <div class="input-group">
                                ...
                                <textarea maxlength="100" rows="4" name="demand"
                                          class="form-control" placeholder="请输入项目需求（例如：小组成员需精通面向对象的分析与设计，会sql查询语句的优化，对MVC模式要有深入的了解等）(0~100个字符之间)" required="required">${projectExtends.demand}</textarea>
                            </div>
                        </td>
                        <td></td>
                    </tr>
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <textarea maxlength="100" rows="4" name="introduction"
                                          class="form-control" placeholder="请输入项目介绍（例如：本系统是基于SSM框架的图书管理系统，是一个由人、计算机等组成的能进行管理信息的收集、传递、加工、保存、维护和使用的系统。利用信息控制企业的行为；帮助企业实现其规划目标）(0~100个字符之间)" required="required">${projectExtends.introduction}</textarea>
                            </div>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><div class="input-group">
                            ...
                            <input maxlength="10" name="numbers" class="form-control" type="number"
                                   value="${projectExtends.numbers}" placeholder="请输入项目需要人数 " required="required" />
                        </div></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><div class="input-group">
                            <span class="input-group-addon">项目进度</span>
                            <div>
                                <c:choose>
                                    <c:when test="${projectExtends.progress == 0}">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="0" checked disabled>开始
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="20">需求分析
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="40">项目启动
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="60">项目计划
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="80">项目实施
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="100">结束
                                        </label>
                                    </c:when>
                                    <c:when test="${projectExtends.progress == 20}">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="0" checked disabled>开始
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="20" checked disabled>需求分析
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="40">项目启动
                                        </label>
                                    ...
                                    <c:when test="${projectExtends.progress == 40}">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="0" checked disabled>开始
                                        </label>
                                        <label class="checkbox-inline">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="40" checked disabled>项目启动
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="60">项目计划
                                        </label>
                                    ...
                                    <c:when test="${projectExtends.progress == 60}">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="0" checked disabled>开始
                                        </label>
                                        <label class="checkbox-inline">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="60" checked disabled>项目计划
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="80">项目实施
                                        </label>
                                    ...
                                    <c:when test="${projectExtends.progress == 80}">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="0" checked disabled>开始
                                        </label>
                                        <label class="checkbox-inline">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="80" checked disabled>项目实施
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="100">结束
                                        </label>
                                    </c:when>
                                    <c:when test="${projectExtends.progress == 100}">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="0" checked disabled>开始
                                        </label>
                                        <label class="checkbox-inline">
                                        ...
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="progresses" value="100" checked disabled>结束
                                        </label>
                                    </c:when>
                                </c:choose>
                            </div>
                    ...
                    <%--<tr>
                        <td><div class="input-group">
                                <span class="input-group-addon">项目进度</span>
                                <input name="progress" class="form-control" type="number" min="0" max="100"
                                       value="${projectExtends.progress}" placeholder="请0~100之间的数字 " required="required">
                ...
                <button class="btn btn-success" type="submit"
                        style="margin-top: 30px; width: 100px;">修改</button>
