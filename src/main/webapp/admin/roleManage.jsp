        ...
        <div class="reloadForm layui-form">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <button class="layui-btn" type="button" onclick="javascript:window.location.href='${cps}/role/editRole.do'">添加角色</button>
                </div>
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    <button class="searchBtn layui-btn" data-type="reload">查找角色</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.use(['layer', 'table', 'element', 'form'], function(){
        ...
        table.render({
            ...
            ,id: 'roleReload'
            ,height: 420
            ,url: '${cps}/role/listRole.do'
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'roleid', title: 'ID', width:100, sort: true, fixed: 'left'}
                ,{field: 'rolename', title: '角色名称', width:800}
