        ...
        <div class="reloadForm layui-form">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <button class="layui-btn" type="button" onclick="javascript:window.location.href='${cps}/type/editProjectType.do'">添加项目类型</button>
                </div>
                ...
                <div class="layui-input-inline" style="width: 100px">
                    <select id="condition" name="condition" lay-verify="required" lay-search="">
                        ...
                        <option value="2">项目类型名称</option>
                    </select>
                </div>
                <div class="layui-input-inline" style="width: 100px;">
                    <button class="searchBtn layui-btn" data-type="reload">查找项目类型</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.use(['layer', 'table', 'element', 'form'], function(){
        ...
        table.render({
            ...
            ,id: 'typeReload'
            ,height: 420
            ,url: '${cps}/type/listProjectType.do'
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'typeid', title: 'ID', width:80, sort: true, fixed: 'left'}
                ,{field: 'typename', title: '项目类型名称', width:250}
                ,{field: 'introduction', title: '项目类型简介', width:580, sort: true}
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(layEvent === 'detail'){
                window.location.href='${cps}/type/editProjectType.do?typeid='+data.typeid;
            } else if(layEvent === 'del'){
                layer.confirm('真的删除行么', function(index){
                    $.ajax({
                        type: "POST",
                        async:true,
                        url: "${cps}/type/deleteProjectType.do",
