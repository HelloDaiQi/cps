        ...
        <div class="reloadForm layui-form">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <button class="layui-btn" type="button" onclick="javascript:window.location.href='${cps}/school/editSchool.do'">添加年级</button>
                </div>
                ...
                <div class="layui-input-inline" style="width: 100px">
                    <select id="condition" name="condition" lay-verify="required" lay-search="">
                        ...
                        <option value="2">年级名称</option>
                    </select>
                </div>
                <div class="layui-input-inline" style="width: 100px;">
                    <button class="searchBtn layui-btn" data-type="reload">查找年级</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.use(['layer', 'table', 'element', 'form'], function(){
        ...
        table.render({
            ...
            ,id: 'gradeReload'
            ,height: 420
            ,url: '${cps}/grade/listGrade.do'
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'gradeid', title: 'ID', width:80, sort: true, fixed: 'left'}
                ,{field: 'gradename', title: '年级名称', width:250}
                ,{field: 'introduction', title: '年级简介', width:580, sort: true}
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(layEvent === 'detail'){
                window.location.href='${cps}/grade/editGrade.do?gradeid='+data.gradeid;
            } else if(layEvent === 'del'){
                layer.confirm('真的删除行么', function(index){
                    $.ajax({
                        type: "POST",
                        async:true,
                        url: "${cps}/grade/deleteGrade.do",
