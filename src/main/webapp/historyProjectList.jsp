                        ...
                        <c:otherwise>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class=""><a
                                            href="${cps}/message/receiveMessageList.do">我的私信</a></li>
                                    <li class="divider"></li>
        ...
        <div class="col-md-10">
            <div class="row">
                ...
                <div style="float: right;">
                    <form class="form-inline" action="${cps}/index/projectList.do" method="post">
        ...
        <div class="col-md-10">
            <ol class="list-unstyled list-inline">
                <c:forEach var="projectExtends" items="${projectExtendsList}">
                    <li><a target="_blank"
                           href="${cps}/index/showProject.do?projectid=${projectExtends.projectid}">
                        <img style="height: 150px; width: 150px"
                             src="${cps}/mysrc/${projectExtends.projectimage}" /><br />
                        项目名称：${projectExtends.projectname}<br />
                        项目类型：${projectExtends.type.typename}<br />
        ...
        <div class="col-md-12" align="center">
            <ul class="pagination pagination-lg">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${cps}/index/showProject.do?page=${pageData.pageNum-1}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">Prev</a></li>
                    </c:otherwise>
                </c:choose>
                <%-- 页码 --%>
                <c:forEach var="pageSize" begin="1" end="${pageData.pages}">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class=""><a href="${cps}/index/showProject.do?page=${pageSize}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">${pageSize}</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                <%-- 尾页 --%>
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${cps}/index/showProject.do?page=${pageData.pageNum+1}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">Next</a></li>
                    </c:otherwise>
                </c:choose>
            </ul>
        </div>
