        ...
        <div class="col-md-10">
            <div class="row">
                ...
                <div style="float: right;">
                    <form class="form-inline" action="${cps}/index/projectListOfUserRelease.do" method="post">
                        <label for="sel1">发布人:</label>
                        <select class="form-control <%--selectpicker show-tick--%>" name="releaser" id="sel1" data-live-search=”true”>
        ...
        <div class="col-md-6">
            <ul class="media-list">
                <c:forEach var="projectExtends" items="${projectExtendsList}">
                    <li class="media">
                        <a class="pull-left" href="${cps}/index/showProject.do?projectid=${projectExtends.projectid}">
                            <img class="media-object" style="height: 150px; width: 150px" src="${cps}/mysrc/${projectExtends.projectimage}"
                                 alt="通用的占位符图像">
                        </a>
                        <div class="media-body">
                            <h4 class="media-heading">项目名称：${projectExtends.projectname}</h4>
        ...
        <div class="col-md-12" align="center">
            <ul class="pagination pagination-lg">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${cps}/index/projectListOfUserRelease.do?page=${pageData.pageNum-1}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">Prev</a></li>
                    </c:otherwise>
                </c:choose>
                <%-- 页码 --%>
                <c:forEach var="pageSize" begin="1" end="${pageData.pages}">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class=""><a href="${cps}/index/projectListOfUserRelease.do?page=${pageSize}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">${pageSize}</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                <%-- 尾页 --%>
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${cps}/index/projectListOfUserRelease.do?page=${pageData.pageNum+1}&projectname=${ipsd.projectname}&projecttype=${ipsd.projecttype}&releaser=${ipsd.releaser}">Next</a></li>
                    </c:otherwise>
                </c:choose>
            </ul>
        </div>
